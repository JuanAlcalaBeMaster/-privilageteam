...
var Request = /** @class */ (function () {
    function Request(baseUrl) {
        this.baseUrl = baseUrl || "".concat(process.env.URL_BASE_REQUEST);
    }
    Request.setAuthorizationDefault = function (auth) {
        return headerObjectDefault[Object.keys(auth)[0]](auth.token);
    };
    Request.prototype.get = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var headersTemp, response, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        headersTemp = void 0;
                        if (options.headers) {
                            headersTemp = __assign({}, options.headers);
                        }
                        else {
                        ...
                        return [4 /*yield*/, axios_1["default"].get("".concat(options.url ? options.url : this.baseUrl + options.endpoint), __assign({}, headersTemp))];
                    case 1:
                        response = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_2 = _a.sent();
                        throw new Error("Request Error: ".concat(error_2));
                    case 3: return [2 /*return*/];
                }
            });
        });
    ...
    Request.prototype.put = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var headersTemp, response, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 2:
                        error_3 = _a.sent();
                        throw new Error("Request Error: ".concat(error_3));
                    case 3: return [2 /*return*/];
                }
            });
        });
